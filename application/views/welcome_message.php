...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'contents/styles/bootstrap.css'; ?> " />
          <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'contents/styles/pop-up-booking.css'; ?> " />
    <script>
...
<script type="text/javascript">
 ...
 $.ajax({
 type: "POST",
 url: "<?php echo 'http://localhost/reservation/index.php/room_booking/post_action';?>",
 data: {
     'checkin' : checkin,
     'checkout' : checkout,
     'adult' : adult,
...
<div id="right" class="popup" style="display: none">
    <div>
    <div class="popupTitleBox" style='width: 1000px;' >
