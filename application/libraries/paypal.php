...
{
#Account information
$config["business"] = 'lchapagain4_api1.gmail.com'; //Account email or id
...
$config["return"] = 'http//localhost/smartaservices/paymets/notify_payment'; //The URL to which PayPal redirects buyersÃ¢â‚¬â„¢ browser after they complete their payments.
$config["cancel_return"] = 'http//localhost/smartaservices/paymets/cancel_payment'; //Specify a URL on your website that displays a Ã¢â‚¬Å“Payment CanceledÃ¢â‚¬Â page.
$config["notify_url"] = 'http//localhost/smartaservices/paymets/cancel_payment'; //The URL to which PayPal posts information about the payment (IPN)
...
$config["first_name"] = 'Ram Prasak';
$config["last_name"] = 'Pathak';
$config["address1"] = 'bharatpur';
$config["address2"] = 'chitwan';
$config["city"] = 'Chitwan';
$config["state"] = 'Narayani';
$config["zip"] = '48948';
$config["email"] = 'infotechnab@gmail.com';
$config["night_phone_a"] = '39472979';
